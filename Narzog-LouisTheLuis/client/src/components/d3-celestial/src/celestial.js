...
!(function() {
  ...
  var ANIMDISTANCE = 0.06,  // Rotation animation threshold, ~2deg in radians
      ANIMSCALE = .02,       // Zoom animation threshold, scale factor
      ANIMINTERVAL_R = 2000, // Rotation duration scale in ms
      ANIMINTERVAL_P = 2500, // Projection duration in ms
      ANIMINTERVAL_Z = 1900, // Zoom duration scale in ms
